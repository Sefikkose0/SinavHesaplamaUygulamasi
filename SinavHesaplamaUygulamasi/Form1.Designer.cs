namespace SinavHesaplamaUygulamasi
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			label3.Location = new Point(99, 184);
			label3.Name = "label3";
			...
			label4.Location = new Point(93, 235);
			label4.Name = "label4";
			...
			// textBox1
			// 
			textBox1.Location = new Point(151, 79);
			...
			// textBox2
			// 
			textBox2.Location = new Point(151, 130);
			...
			// textBox3
			// 
			textBox3.Location = new Point(151, 181);
			...
			textBox4.Location = new Point(151, 232);
			...
			button1.Location = new Point(133, 303);
			...
			Controls.Add(label1);
			Name = "Form1";
			Text = "Sınav Hesaplama Uygulaması";
			ResumeLayout(false);
			PerformLayout();
		}
